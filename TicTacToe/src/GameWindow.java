...
public class GameWindow implements MouseHandler {
    ...
    private void updateScoreBoard() {
        ...
        Picture picture = new Picture(1015, 400, "rsc/scoreboard.png");
        picture.draw();
        scoreBoard1 = new Text(PADDING + 1150, PADDING + 630, player1Wins + "");
        scoreBoard2 = new Text(PADDING + 1370, PADDING + 630, player2Wins + "");
    ...
    private void drawGrid() {
        ...
        background.draw();
        Picture title = new Picture(920,0, "rsc/Title.png");
        title.draw();
    ...
    private void drawX(int row, int col) {
        ...
        Picture picture = new Picture(x + PADDING, y + PADDING, "rsc/x2.png");
        picture.draw();
    ...
    private void drawO(int row, int col) {
        ...
        Picture picture = new Picture(x + PADDING, y + PADDING, "rsc/o2.png");
        picture.draw();
        pictureList.add(picture); // Track the picture for later deletion
    }
